...
!function(t){t.fn.hoverIntent=function(e,o,n){var i={interval:100,sensitivity:7,timeout:0};i="object"==typeof e?t.extend(i,e):t.isFunction(o)?t.extend(i,{over:e,out:o,selector:n}):t.extend(i,{over:e,out:e,selector:o});var s,a,r,l,p=function(t){s=t.pageX,a=t.pageY},u=function(e,o){return o.hoverIntent_t=clearTimeout(o.hoverIntent_t),Math.abs(r-s)+Math.abs(l-a)<i.sensitivity?(t(o).off("mousemove.hoverIntent",p),o.hoverIntent_s=1,i.over.apply(o,[e])):(r=s,l=a,o.hoverIntent_t=setTimeout(function(){u(e,o)},i.interval),void 0)},m=function(t,e){return e.hoverIntent_t=clearTimeout(e.hoverIntent_t),e.hoverIntent_s=0,i.out.apply(e,[t])},c=function(e){var o=jQuery.extend({},e),n=this;n.hoverIntent_t&&(n.hoverIntent_t=clearTimeout(n.hoverIntent_t)),"mouseenter"==e.type?(r=o.pageX,l=o.pageY,t(n).on("mousemove.hoverIntent",p),1!=n.hoverIntent_s&&(n.hoverIntent_t=setTimeout(function(){u(o,n)},i.interval))):(t(n).off("mousemove.hoverIntent",p),1==n.hoverIntent_s&&(n.hoverIntent_t=setTimeout(function(){m(o,n)},i.timeout)))};return this.on({"mouseenter.hoverIntent":c,"mouseleave.hoverIntent":c},i.selector)}}(jQuery);
...
function imageBreakpointSwitch(){$("img.responsive").each(function(){var t=$(this).attr("src"),e=t.split("/"),o=e.pop();e=e.join("/");var o=o.split("."),n=o.pop();switch(!0){case res_x<breakpoints[0]+1:var i=o.join(".")+"_"+breakpoints[0]+"."+n;break;case res_x<breakpoints[1]+1:var i=o.join(".")+"_"+breakpoints[1]+"."+n;break;case res_x<breakpoints[2]+1:var i=o.join(".")+"_"+breakpoints[2]+"."+n;break;case res_x<breakpoints[3]+1:var i=o.join(".")+"_"+breakpoints[3]+"."+n;break;case res_x<breakpoints[4]+1:var i=o.join(".")+"_"+breakpoints[4]+"."+n;break;default:return!1}var s=e+"/"+i;$(this).attr("src",s)})}function retinaSwitch(){var t=window.devicePixelRatio?window.devicePixelRatio:1;t>1&&$("img.hires").each(function(){var t=$(this).attr("src"),e=t.substr(t.lastIndexOf(".")),o=t.replace(e,""),n=o+"@2x"+e;$(this).attr("src",n)})}function checkMenu(){$(window).width()<mob_to_desk?($("#togglemenu").click(function(){$("nav.header__mainmenu ul.menu").slideToggle(),$(this).html(1==$("nav.header__mainmenu ul.menu").height()?'<i class="fa fa-close"></i>':'<i class="fa fa-bars"></i>')}),$("nav.header__mainmenu .menu > li").has("ul").append('<div class="arrow lv1"><i class="fa fa-chevron-down"></i></div>'),$("nav.header__mainmenu .menu > li > div.arrow").on("click",function(){$(this).parent().children("ul.submenu").slideToggle(function(){$(this).parent().find("div.arrow.lv1").html("block"==$(this).css("display")?'<i class="fa fa-chevron-up"></i>':'<i class="fa fa-chevron-down"></i>')})}),$("nav.header__mainmenu .submenu > li").has("ul").append('<div class="arrow lv2"><i class="fa fa-chevron-down"></i></div>'),$("nav.header__mainmenu .submenu > li > div.arrow").on("click",function(){$(this).parent().children("ul.submenu > li > .submenu").slideToggle(function(){$(this).parent().find("div.arrow.lv2").html("block"==$(this).css("display")?'<i class="fa fa-chevron-up"></i>':'<i class="fa fa-chevron-down"></i>')})})):($("nav.header__mainmenu .menu li").hoverIntent({over:function(){$(this).find("ul").first().fadeIn("fast")},out:function(){$(this).find("ul").first().fadeOut("fast")},timeout:100}),$("nav.header__mainmenu .submenu li").each(function(t){$(this).hasClass("active")&&($(this).children("nav.header__mainmenu ul.submenu").show(),$(this).children("div.arrow").html('<i class="fa fa-chevron-up"></i>'))}),$("nav.header__mainmenu .menu > li").has("ul").append('<div class="arrow lv1"><i class="fa fa-chevron-down"></i></div>'),$("nav.header__mainmenu .submenu > li").has("ul").append('<div class="arrow lv2"><i class="fa fa-chevron-right"></i></div>'))}function toTop(){$(".footer__totop").on("click",function(){$("html,body").animate({scrollTop:0},500)})}function checkTop(){return $(window).scrollTop()>200?!0:!1}
;var res_x=$(window).width(),res_y=$(window).height(),breakpoints=Array(320,480,768,1024,1200),mob_to_desk=768;$(function(){checkMenu(),toTop(),$("#main-slider").owlCarousel({navigation:!0,pagination:!0,slideSpeed:300,paginationSpeed:400,singleItem:!0}),console.log("ready")}),$(window).on("load",function(){console.log("loaded")}),window.DeviceOrientationEvent&&window.addEventListener("orientationchange",function(){location.reload()}),$(window).on("scroll",function(){checkTop()?$(".footer__totop").fadeIn():$(".footer__totop").fadeOut()});
